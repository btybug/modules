                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            <a href="{{URL('/admin/modules/theme/variations/'.$template->id)}}" class="btn btn-xs btn-success pull-right" style="color:#fff;">Add Layout</a>
                        </h4>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                            ...
                                            <a href="/admin/modules/theme/settings-live-layout/{{$variation_data->id}}" class="btn btn-default btn-warning btn-xs">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
...
@section('JS')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.editable').editable({
                url: '/admin/modules/theme/editvariation',
        ...
        $('.edit-variation').on('click',function(){
            ...
            $.ajax({
                type: "post",
                url: "{!! url('/admin/modules/theme/get-variations') !!}",
                cache: false,
                datatype: "json",
                data:data,
                headers: {
