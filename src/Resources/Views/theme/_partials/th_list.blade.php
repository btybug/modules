        ...
        <div class="row themes m-b-10">
            <div class="col-xs-12 p-l-0 p-r-0">
                @if(isset($theme->image))
                    <img src="{!! url('resources/templates/'.$theme->type.'/'.$theme->slug. '/images/'. $theme->image)!!}"
            ...
            <div class="col-xs-12 templates-header p-t-10 p-b-10">
                <span class="pull-left templates-title f-s-15 col-xs-6 col-sm-6 col-md-6 col-lg-6 p-l-0  "><i
                            class="fa fa-bars f-s-13 m-r-5" aria-hidden="true"></i> {!! $theme->name or $theme->slug !!}</span>
                <div class="pull-right templates-buttons col-xs-6 col-sm-6 col-md-6 col-lg-6 p-r-0 text-right ">
                    ...
                    <a href="{!! url($theme->settings_url) !!}" class="addons-settings  m-l-10 m-r-10"><i
                    ...
                    @else
                        <a href="{!! url('/admin/modules/theme/front-themes-activate',$theme->slug) !!}"
                           class="label label-info m-r-10 activate-theme" style="cursor: pointer;">Activate</a>
                    @endif
                    <a href="javascript:void(0)" slug="{!! $theme->slug !!}" class="addons-delete del-tpl"><i
