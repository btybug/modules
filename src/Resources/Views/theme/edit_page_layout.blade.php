...
<iframe data-reloadiframe="iframe1" id="layoutViewSetting" src="{!! url('/admin/modules/theme/settings-iframe-layout',$layout) !!}"></iframe>
<iframe data-reloadiframe="iframe2" class="hide" src="{!! url('/admin/modules/theme/settings-iframe-layout',$layout) !!}"></iframe>
</div>
<input type="hidden" data-selectedlayout="" value="{!! url('/admin/templates/settings-iframe-layout',$layout) !!}" >
<input type="hidden" data-url="{!! url('/admin/modules/theme/front-layout-settings',$layout) !!}" >
