...
@section('content')
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <div class="container">
                <ul class="nav navbar-nav tabnav">
                    <li class="active"><a href="{!! url('/admin/modules/config/'.$slug.'/buildb/pages') !!}">Pages</a>
                    </li>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 up">
            <button class="add-new-adminpage btn btn-primary pull-left"><i class="fa fa-plus" aria-hidden="true"></i>Create
                New
            </button>
        </div>
                ...
                <div class="panel panel-darkblack panels accordion_panels">
                    ...
                    <div class="panel-heading bg-black-darker text-white accordion" role="tab" id="headingLink">
                        ...
                        <a role="button" class="panelcollapsed collapsed" data-toggle="collapse"
                           data-parent="#accordion" href="#collapseLink_general" aria-expanded="true"
                           aria-controls="collapseLink_general">
                    ...
                    <div id="collapseLink_general" class="panel-collapse collapse in" role="tabpanel"
                         aria-labelledby="headingLink">
                        <div class="panel-body panel_body panel_1 show">
                            <p class="change_layout"><strong> Change all Pages Layout
                                    :</strong> {!! Form::select('layout_id',['' => 'Select Layout'] + $layouts,null,['class' => 'form-control input-md']) !!}
                            </p>
