                    ...
                    <div class="panel panel-default panels accordion_panels">
                        <div class="panel-heading bg-black-darker text-white"  role="tab" id="headingLink">
                            ...
                            <a role="button" class="panelcollapsed collapsed" data-toggle="collapse"
                               data-parent="#accordion" href="#collapseLink_all_pages" aria-expanded="true" aria-controls="collapseLink_all_pages">
                        ...
                        <div id="collapseLink_all_pages" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingLink">
                        ...
                        <div class=" p-r-0 hide" id="page-details">
                            <div class="panel panel-default panels accordion_panels">
                                <div class="panel-heading bg-black-darker text-white" role="tab" id="headingLink">
                                    ...
                                    <a role="button" class="panelcollapsed collapsed" data-toggle="collapse"
                                       data-parent="#accordion" href="#collapseLink_quick_view" aria-expanded="true" aria-controls="collapseLink_quick_view">
                                        <i class="fa fa-chevron-down" aria-hidden="true"></i>
                                    </a>
                                    <ul class="list-inline panel-actions">
                                        <li><a href="#" panel-fullscreen="true" role="button" title="Toggle fullscreen"><i class="glyphicon glyphicon-resize-full"></i></a></li>
                                ...
                                <div id="collapseLink_quick_view" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingLink">
                                    <div class="panel-body form-horizontal panel_body panel_1 show">
                                        <ul class="quick-view-list">
                                            ...
                                            <li><strong>Page Visibility:</strong> <span id="pg-detail-visibility"></span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" p-r-0 hide" id="page-layout-options">
                                <div class="panel panel-default panels accordion_panels">
                                    <div class="panel-heading bg-black-darker text-white" role="tab" id="headingLink">
                                        ...
                                        <a role="button" class="panelcollapsed collapsed" data-toggle="collapse"
                                           data-parent="#accordion" href="#collapseLink_options" aria-expanded="true" aria-controls="collapseLink_options">
                                            <i class="fa fa-chevron-down" aria-hidden="true"></i>
                                        </a>
                                        <ul class="list-inline panel-actions">
                                            <li><a href="#" panel-fullscreen="true" role="button" title="Toggle fullscreen"><i class="glyphicon glyphicon-resize-full"></i></a></li>
                                    ...
                                    <div id="collapseLink_options" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingLink">
                                        <div class="panel-body form-horizontal panel_body panel_1 show">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <select class="form-control" name="layout_option">
                                                        <option value="layout_except_body">All child pages will Inherit same parent layout except body</option>
                                                        <option value="layout_except_body_extra">All child pages will Inherit same parent layout except body and extra</option>
                                                        <option value="layout_except_sidebar">All child pages will Inherit same parent layout except body and side bars</option>
                                            ...
                                            <div class="hide" id="new-child-page" >
                                                ...
                                                <div class="panel panel-default panels accordion_panels">
                                                    <div class="panel-heading bg-black-darker text-white" role="tab" id="headingLink">
                                                        ...
                                                        <a role="button" class="panelcollapsed collapsed" data-toggle="collapse"
                                                           data-parent="#accordion" href="#collapseLink_add_page" aria-expanded="true" aria-controls="collapseLink_add_page">
                                                            <i class="fa fa-chevron-down" aria-hidden="true"></i>
                                                        </a>
                                                        <ul class="list-inline panel-actions">
                                                            <li><a href="#" panel-fullscreen="true" role="button" title="Toggle fullscreen"><i class="glyphicon glyphicon-resize-full"></i></a></li>
                                                    ...
                                                    <div id="collapseLink_add_page" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingLink">
                                                        <div class="panel-body form-horizontal panel_body panel_1 show">
                                                            <!-- Error Message -->
