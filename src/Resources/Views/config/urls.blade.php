                             ...
                             <div class="form-group">
                                 <div class="col-sm-4">
                                     <div class="customradio radio">
                                              <input type="radio" id="404" checked data-typepage="404"  name="redirect"  @if(isset($settings->val) and $settings->val==404) checked @endif value="404"><label for="404">404</label>
                                      </div>
                                     <div class="customradio radio">
                                              <input type="radio" id="505"  data-typepage="505"  name="redirect" @if(isset($settings->val) and $settings->val==505) checked @endif value="505"><label for="505">505</label>
                                      </div>
                                       <div class="customradio radio">
                                              <input type="radio" id="custom_url" data-typepage="custom_url" name="redirect" @if(isset($settings->val) and $settings->val!=505 and $settings->val!=404) checked @endif value="custom"><label for="custom_url">Custom url</label>
                                      </div>
                                   </div> 
                                <div class="col-sm-8" >
                                <div data-targetpage="custom_url" class="hide">
                                    <label for="redirectto" class="col-sm-4 control-label p-r-5"><i class="fa fa-file-text" aria-hidden="true"></i>Redirect to</label>
                                    <div class="col-sm-8"> <input type="text" name="redirectto" id="redirectto" value="{!! $settings->val or null !!}" class="form-control"></div>
                                </div>
                                </div>
                ...
                <div class="formdatainfo formfixed"  data-put="forminfo">
                    <div class="row">
                        <div  class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
                            <div class="form-group">
                                <div class="col-sm-11">
                                    <input type="text" name="url" id="url" value="admin/modlu" readonly class="form-control">
                                </div>
                                 <div class="col-sm-1">
                             ...
                             <div class="form-group">
                                 <div class="col-sm-4">
                                     <div class="customradio radio">
                                              <input type="radio" id="havepage" checked data-typepage="havepage"  name="page" value="on"><label for="havepage">Have Page</label>
                                      </div>
                                   </div>
                                <div class="col-sm-7" >
                                  <div >
                                    <label for="pagename" class="col-sm-4 control-label p-r-5"><i class="fa fa-file-text" aria-hidden="true"></i>Page name </label>
                                    <div class="col-sm-8"> <input type="text" name="pagename" id="pagename" value="Abokamal" class="form-control"></div>
                                </div>
                                </div>
