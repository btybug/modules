        ...
        <article>
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9 buttons">
                <div class="pull-right">
                    <button class="save_btn"><i class="fa fa-check" aria-hidden="true"></i>Save</button></div>
            </div>
            {!! Form::model($page) !!}
                                ...
                                <div>
                                    ...
                                    <div class="row rows">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 row_inputs tagitinout">
                                              <input name="tags" class="hide tagitext" data-allwotag="admin,user" value="">
                                                <ul id="tagits" class="tagInputList" data-allwotag="admin,user" class="m-b-0 tagit ui-widget ui-widget-content ui-corner-all">
                                                </ul>
                                        </div>
                                    </div>
                                    <div class="row rows">
                    ...
                    <div class="panel-heading">
                        <div class="row panel_head">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 body_layout">
                                ...
                                <a target="_blank" href="{!! url('/admin/modules/config/page-preview/'.$page->id.'?pl='.$page->layout_id) !!}" class="apply apply_contents">Apply Contents</a>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7 col-xl-7">
                                <img src="{!!  url('\resources\assets\images\create-pages.png') !!}" alt="image" class="header_image">
                            </div>
