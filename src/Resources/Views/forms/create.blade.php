...
@section('content')
    ...
    <div class="builderWrapper">
        <div class="builderHeader row">
            <div class="col-xs-6 col-sm-6 p-t-10">
                ...
                <button class="btn btn-default btn-sm btn-builder-gray" data-toggle="modal" data-target="#settingform">
            ...
            <div class="col-xs-6 col-sm-6 text-right p-0">
                ...
                <a href="#" class="btn btn-link btn-link-gray" data-value="{!!$form->id or null!!}" data-save="form"><i
                            class="fa fa-check" aria-hidden="true"></i> Save</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <form class="navbar-form navbar-left">
                            ...
                            <button type="button" class="btn btn-default setting_button"><i class="fa fa-cog"
                                                                                            aria-hidden="true"></i>Setting
                            </button>
                            <button class="btn btn-default edit_button"><i class="fa fa-pencil" aria-hidden="true"></i>Edit
                            </button>
                        </form>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3 p-0 builderleft_section">
                    <ul class="nav nav-tabs nav-justified builder-tabs" data-fieldtab="">
                        <li class="active"><a href="#builderFields" aria-controls="builderFields" role="tab"
                                              data-toggle="tab" data-dragdata="builderFields" data-val="0"> <i
                                        class="buidericon bildericon-field"></i> Fields</a></li>
                        <li><a href="#builderTool" aria-controls="builderTool" role="tab" data-toggle="tab"
                               data-dragdata="builderTool" data-val="general"> <i
                                        class="buidericon bildericon-tool"></i> Tool</a></li>
                    </ul>
                                    ...
                                    @if(count($fields))
                                        <ul id="sortable1" class="connectedSortable fields" data-sortlist="field">
                                            @foreach($fields as $field)
                                                <li class="dragdiv connectedSortable height-40 text-center"
                                                    data-button="edit,delete" data-type="field"
                                                    data-title="{{ $field->column_name }}" data-uniq="{!! uniqId() !!}"
                                                    data-el="{!! $field->id  !!}">
                                                    <span class="listoficon bbicongreen"><i
                                                                class="glyphicon glyphicon-minus"></i></span> {{ $field->column_name }}
                                                </li>
                                            @endforeach
                                        </ul>
                                    @else
                                    ...
                                    @if(count($unconfigured))
                                        <ul class="unconfigured_fields">
                                            @foreach($unconfigured as $f)
                                                <li class="dragdiv  height-40 text-center" data-button="edit,delete"
                                                    data-type="field" data-title="{{ $f->Field }}"
                                                    data-uniq="{!! uniqId() !!}">
                                                    <span class="listoficon bbicongreen"><i
                                                                class="glyphicon glyphicon-minus"></i></span>
                                                    <a href="{!! url('admin/modules/tables/edit-column',[$table,$f->Field]) !!}"
                                                       target="_blank"
                                                       class="btn btn-default btn-sm btn-builder-blue btn-configure"
                                                       title="Configure">
                                    ...
                                    <ul id="sortable1" class=" fields" data-sortlist="tool">
                                        @foreach($units as $unit)
                                            @foreach($unit->variations() as $variation)
                                                <li class="dragdiv connectedSortable height-40 text-center"
                                                    data-button="edit,delete" data-type="tool"
                                                    data-title="{{ $unit->title }}" data-uniq="{!! uniqId() !!}"
                                                    data-el='{!! $variation->id  !!}'>
                                                    <span class="listoficon bbicongreen"><i
                                                                class="glyphicon glyphicon-minus"></i></span> {{ $unit->title }}
                                                    / {{$variation->title}}
                                                </li>
                                            @endforeach
                                        @endforeach
                ...
                <div class="builderright_section">
                    <div class="builder-selectviewrow">
                        <div class="btn-group">
                            <button type="button" class="btn btn-link btn-xs btn-lightgray dropdown-toggle"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-desktop" aria-hidden="true"></i> Desktop view 1620 px <span
                                        class="caret"></span>
                            </button>
                            <ul class="dropdown-menu">
                                <li><a href="#" data-responsive="1620" data-title="Desktop view 1620 px">Desktop view
                                        1620 px</a></li>
                                <li><a href="#" data-responsive="1024" data-title="Table view 1620 px">Table view 1024
                                        px</a></li>
                                <li><a href="#" data-responsive="420" data-title="Moble view 1620 px">Moble view 420
                                        px</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="forwidth builder-canvas" data-builder="canvas">
                        <div class="radio_bt_div hide">
                            <input type="radio" name="column" value="columns_1" checked="checked" class="radio_bt"
                                   id="radiobt_2"><span class="choose_cols">Columns - 1</span>
                            <input type="radio" name="column" value="columns_2" class="radio_bt" id="radiobt_1"><span
                                    class="choose_cols">Columns - 2</span>
                    ...
                    <input type="text" name="json" data-export="json" value='{!! $form->json_data !!}'
                           data-getjson='{!! $form->json_data !!}'/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade bigfullModal bigmodalwhite" id="settingform" tabindex="-1" role="dialog"
         aria-labelledby="settingform">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close btn-red-close " data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title p-t-10" id="myModalLabel"><i
                                class="buidericon bildericon-fieldlayoutbig m-r-10"></i> Setting From</h4>
                </div>
                <div class="modal-body p-10">
                    <ul class="nav nav-tabs col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-pencil-square-o"
                                                                                aria-hidden="true"></i>Email
                                Settings</a></li>
                        <li><a data-toggle="tab" href="#menu1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>General
                                Settings</a></li>
                        <li><a data-toggle="tab" href="#menu2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Menu
                                3</a></li>
                        <li><a data-toggle="tab" href="#menu3"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Menu
                                4</a></li>
                    </ul>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close btn-red-close " data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title p-t-10" id="myModalLabel"><i
                                class="buidericon bildericon-fieldlayoutbig m-r-10"></i> Preview <span
                                data-modalpreview="text"></span></h4>
                </div>
    ...
    <!-- Modal -->
    <div class="modal fade bigfullModal" id="formlayoutpopup" tabindex="-1" role="dialog"
         aria-labelledby="formlayoutpopup">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close btn-red-close " data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title p-t-10" id="myModalLabel"><i
                                class="buidericon bildericon-fieldlayoutbig m-r-10"></i> Form Layout</h4>
                </div>
                <div class="modal-body">
                    <div class="builder-modalleft">
                        <h5>Select Layout</h5>
                        <ul class="filedcolumntype" role="tablist">
                            <li class="active"><a href="#formlayout001" aria-controls="formlayout001" role="tab"
                                                  data-toggle="tab"><img src="/resources/assets/images/form-list.jpg">
                                    <span>Layout 0001</span></a></li>
                            <li><a href="#formlayout002" aria-controls="formlayout002" role="tab" data-toggle="tab"><img
                                            src="/resources/assets/images/form-list2.jpg"><span>Layout 0002</span></a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="formlayout001">
                                <ul class="formlisting">
                                    <li><a href="#"><img src="/resources/assets/images/form-list.jpg">
                                        </a><span><a href="#" class="editlist"><i class="fa fa-pencil"
                                                                                  aria-hidden="true"></i></a>Layout 0001</span>
                                    </li>
                                    <li><a href="#"><img src="/resources/assets/images/form-list.jpg"></a>
                                        <span><a href="#" class="editlist"><i class="fa fa-pencil"
                                                                              aria-hidden="true"></i></a>Layout 0002</span>
                                    </li>
                                </ul>
                            ...
                            <div role="tabpanel" class="tab-pane " id="formlayout002">
                                <ul class="formlisting">
                                    ...
                                    <li><a href="#"><img src="/resources/assets/images/form-list2.jpg"></a>
                                        <span><a href="#" class="editlist"><i class="fa fa-pencil"
                                                                              aria-hidden="true"></i></a>Layout 0003</span>
                                    </li>
                                </ul>
    ...
    <div class="layerswindow editlayerswindow hide" data-window="editlayers">
        <div class="windowHeader">
            <div class="iconRight">
                ...
                <a href="#" class="windowCloseLink builderlayersbtn" data-layersactions="save"><i
                            class="bbthemeIcon themeDonerow"></i></a><a href="#" class="windowDoneLink builderlayersbtn"
                                                                        data-layeraction="close"><i
                            class="bbthemeIcon themecloserow"></i></a>
            </div>
            <div class="listrow colItem-sidebarvertical  active clearfix">
                <div class="listRowName">
                    <span class="listrowicon"><i class="bbthemeIcon bbthemeIcon-edit" data-name=""
                                                 data-role="previewicon"></i></span> <span data-role="previewText">User Name </span>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '[data-draganddrop] li', function () {
                ...
                editchangeInterval = setInterval(function () {
                    editchange()
                }, 300)
