                ...
                <div class="p-0">
                    @if(isset($email_templates['admin']))
                        <div class="p-10">
                            ...
                            <a class="btn btn-default btn-warning btn-xs m-l-20"
                               href="/admin/settings/email/updateemail/{!! $email_templates['admin']->id !!}">
                ...
                <div class="p-0">
                    @if(isset($email_templates['user']))
                        <div class="p-10">
                            ...
                            <a class="btn btn-default btn-warning btn-xs m-l-20"
                               href="/admin/settings/email/updateemail/{!! $email_templates['user']->id !!}">
                                <i class="fa fa-cog set-iconz"></i>
                            </a>
                        </div>
                    @else
