            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <form class="nav navbar-nav navbar-right">
                        <button type="button" class="btn btn-default first_button"><i class="fa fa-trash-o"
                                                                                      aria-hidden="true"></i>Discard
                        </button>
                        <button type="button" class="btn btn-default second_button"><i class="fa fa-floppy-o"
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 right_section">
                    <div class="forwidth">
                        <div class="radio_bt_div">
                            <input type="radio" name="column" value="columns_1" class="radio_bt" id="radiobt_2"
                                   checked="checked"><span class="choose_cols">Columns - 1</span>
                        ...
                        <div class="div_for_cols">
                            <div class="left_part" data-style-old="left_part" data-bbplace="containerstyle_2"
                                 id="left_side">

                            </div>
                            <div class="right_part" data-style-old="right_part" data-bbplace="containerstyle_3"
                                 id="right_side"></div>
                        </div>
        ...
        <div class="div_modal" style="display: none">
            ...
            <ul class="nav nav-tabs col-lg-2 col-md-2 col-sm-2 col-xs-2 ">
                <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-pencil-square-o"
                                                                        aria-hidden="true"></i><br/>Menu 1</a></li>
                <li><a data-toggle="tab" href="#menu1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><br/>Menu
                        2</a></li>
                <li><a data-toggle="tab" href="#menu2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><br/>Menu
                        3</a></li>
                <li><a data-toggle="tab" href="#menu3"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><br/>Menu
                        4</a></li>
            </ul>
