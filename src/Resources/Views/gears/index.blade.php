@extends('btybug::layouts.mTabs',['index'=>'m_gears'])
@section('tab')
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cms_module_list">
            ...
            <ul class="list-unstyled menuList" id="components-list">
                {{--main types--}}
                <li>
                    <a href="?p=layoyts" rel="tab" main-type="layouts" class="tpl-left-items">
                        <span class="module_icon"></span> Layouts
                    </a>
                </li>

                {{--main types--}}
                <li>
                    <a href="?p=fields" rel="tab" main-type="units" class="tpl-left-items">
                        <span class="module_icon"></span> Units
                    </a>
                </li>
                {{--main types--}}
                <li>
                    <a href="?p=others" rel="tab" main-type="main_body" class="tpl-left-items">
                        <span class="module_icon"></span> Main Body
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row m-b-10">
                    ...
                    <div class="raw tpl-list">
                        {{--@include('resources::widgets._partials.list_cube')--}}
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("a[rel='tab']").click(function (e) {
                ...
                $.ajax({
                    url: '/admin/modules/gears/get-gears-lists',
                    data: {
                        ui_type: "{!! $type !!}",
                        main_type: main_type,
                        url: pageurl + '?rel=tab',
