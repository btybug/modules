                ...
                <div class="container-fluid">
                    <ul class="nav navbar-nav tabnav {!! $settings['menustyle'] or null !!}">
                        ...
                        @foreach($settings['menu'] as $key=>$item)
                            <li class=@if(!$key)"active"@endif><a href="{!! $item['url'] !!}">{!! $item['title'] !!}</a></li>
                        @endforeach
                        @endif
                    </ul>
                </div>
...
background:linear-gradient(180deg, rgba(157,200,0,1) 0.14%, rgba(113,150,0,1) 99.75% );
        border: none; border-radius: 0; border-bottom: solid 2px #efefef; box-shadow: 0px 1px 2px rgba(0,0,0,0.2);
...
background:linear-gradient(180deg, #1b98db 0.14%, #0785dc 99.75% );
        border: none; border-radius: 100px; border-bottom: solid 2px #efefef; box-shadow: 0px 1px 2px rgba(0,0,0,0.2);
    ...
    .tabnav>li>a:focus,  .tabnav>li.active>a, .nav>li>a:hover,.nav .open>a, .nav .open>a:focus, .nav .open>a:hover, .dropdown-menu>li>a:focus, .dropdown-menu>li>a:hover{
        ...
        background: #efefef; color: rgba(157,200,0,1); box-shadow: 2px -2px 2px rgba(0,0,0,0.2), -2px -2px 2px rgba(0,0,0,0.1);
    }
  ...
  .menuround>li { padding: 5px;}
  .menuround>li>a { border-radius: 50px; padding: 10px 15px;}
