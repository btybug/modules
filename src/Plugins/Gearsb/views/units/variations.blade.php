    ...
    <div class="row">
                        ...
                        @foreach($variations as $variation_data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/backend/gears/units/live-settings/{{$variation_data->id}}" class="btn btn-default btn-primary btn-xs">&nbsp;<i class="fa fa-desktop"></i>&nbsp;</a>
                                    @if($variation_data->default == 0)
                                        <button value="{{$variation_data->id}}"
                                                class="btn btn-info btn-xs edit-variation">&nbsp;<i
                                                    class="fa fa-pencil"></i>&nbsp;</button>
                                        <a href="/admin/backend/gears/units/delete-variation/{{$variation_data->id}}/{{$unit->id}}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to delete')"> &nbsp;<i class="fa fa-trash"></i> &nbsp;</a>

                                        <a href="/admin/backend/gears/units/make-default-variation/{{$variation_data->id}}/{{$unit->id}}" class="btn btn-primary btn-xs"> &nbsp;make default</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="col-md-4 new-variation @if(empty($variation)) hide @endif">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model('customiser',['method'=>'POST','url'=>'/admin/backend/gears/units/units-variations/'.$unit->slug]) !!}
