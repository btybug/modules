...
//use App\Modules\Frontend\Plugins\Gears\Models\Validation as validateUpl;
...
class UnitsController extends Controller
{
    ...
    public function getIndex()
    {
        ...
        return view('Gears::units.index', compact(['ui_units', 'type', 'types']));
    }
    ...
    public function postUnitWithType (Request $request)
    {
        ...
        $html = View::make('Gears::units._partials.list_cube', compact(['ui_units']))->render();
    ...
    public function getUnitVariations ($slug)
    {
        ...
        return view('Gears::units.variations', compact(['unit', 'variations', 'variation'])
        );
    }
    ...
    public function unitPreview ($id)
    {
        ...
        $ifrem['body'] = url('/admin/frontend/gears/units/settings-iframe', $id);
        $ifrem['settings'] = url('/admin/frontend/gears/units/settings-iframe', $id) . '/settings';

        return view('Gears::units.preview', compact(['ui', 'id', 'ifrem', 'settings']));
    }
    ...
    public function unitPerviewIframe ($id, $type = null)
    {
        ...
        return view('Gears::units._partials.unit_preview', compact(['htmlBody', 'htmlSettings', 'settings', 'settings_json', 'id', 'ui']));
    }
