    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cms_module_list">
            ...
            <ul class="list-unstyled menuList" id="components-list">
                {{--main types--}}
                <li class="active">
                    <a href="?=header"  rel="tab" main-type="header" class="tpl-left-items">
                        <span class="module_icon"></span> Headers
                    </a>
                </li>
                {{--main types--}}
                <li>
                    <a href="?p=footer" rel="tab" main-type="footer" class="tpl-left-items">
                        <span class="module_icon"></span>  Footers
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row m-b-10">
                    ...
                    <div class="raw tpl-list">
                        @include('Gears::hf.list_cube',compact('templates'))
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("a[rel='tab']").click(function(e){
                ...
                $.ajax({
                    url: '/admin/frontend/gears/templates-with-type',
                    data: {
                        main_type: main_type,
                        url:pageurl+'?rel=tab',
                        type: general_type
