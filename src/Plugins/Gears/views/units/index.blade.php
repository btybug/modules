    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cms_module_list">
            <h3 class="menuText f-s-17">
                ...
                <span class="module_icon_main_text">Frontend Units </span>
            </h3>
            <hr>
            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row templates m-b-10">
                    ...
                    <div class="raw tpl-list">
                        @include('Gears::units._partials.list_cube')
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url'=>'/admin/frontend/gears/units/upload-unit','class'=>'dropzone', 'id'=>'my-awesome-dropzone']) !!}
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.list-unstyled').on('click', '.tpl-left-items', function(e) {
                ...
                $.ajax({
                    url: '/admin/frontend/gears/units/unit-with-type',
                    data: {
                        main_type: main_type,
                        url:pageurl+'?rel=tab',
                        type: general_type
            ...
            $('body').on('click','.del-tpl',function(){
                ...
                $.ajax({
                    url: '/admin/frontend/gears/units/delete',
                    data: {
                        slug: slug
                    },
                    headers: {
